...
class Gallery extends Component {
  ...
  componentDidMount() {
    ...
    fetch("https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=86bac430e1df7d14e6ae2a0f661ed7dc&format=json&nojsoncallback=1&tags=cat&extras=description,date_upload,owner_name,geo,tags,views,url_m&per_page=12")
